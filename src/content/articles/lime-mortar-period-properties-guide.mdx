...
excerpt: "Why cement mortar is destroying Britain's historic buildingsâ€”and how lime mortar restoration can save your Georgian or Victorian property from structural damage."
author: "The Hampstead Design Journal"
featured: true
---

If your Georgian or Victorian property has been repointed with cement mortarâ€”as the majority have been at some pointâ€”you may be watching your building slowly destroy itself. The hard grey cement that seemed like a sensible twentieth-century improvement is, in fact, causing cracks, spalling brickwork, and trapped moisture that will eventually require costly repair.
...
Georgian and Victorian buildings were designed as "breathing" structures. The soft, porous materialsâ€”handmade bricks, lime mortar, lime plaster, and lime renderâ€”allowed moisture to move through the building fabric:
...
This moisture movement kept buildings dry despite having no damp-proof courses, cavity walls, or modern membranes. The system worked because all componentsâ€”especially the mortarâ€”were permeable.
...
**Frost damage**: Trapped moisture freezes in winter, expanding within the brick faces. This causes spallingâ€”the characteristic pattern where brick faces flake away while cement joints remain intact.
...
5. **Crumbling cement**: Ironically, cement also fails eventuallyâ€”cracks and gaps where pointing has separated from bricks
...
Budget Â£500-Â£2,000 for professional assessment depending on building size.
...
Lime mortar is not bagged cement mixâ€”it requires skill to prepare:

**Proportions**: Typically 1 part NHL lime to 2.5-3 parts aggregate (varies by specification)

**Mixing**: Combine dry materials, then add water gradually. Mix until "fatty" consistencyâ€”more plastic than cement mortar.
...
**First month**: Protect from frost (lime does not set below 5Â°C)
**Three months+**: Full carbonation takes months; lime strengthens over years

Work should be scheduled for mild weatherâ€”spring and early autumn are ideal. Winter work requires temporary heating and protection.
...
|--------------|-----------------|---------------|
| Material cost | Â£5-10/sqm | Â£15-30/sqm |
| Labour (removal + repoint) | Â£40-60/sqm | Â£80-150/sqm |
| Scaffolding | Same | Same |
| Total typical cost | Â£60-90/sqm | Â£120-200/sqm |

For a typical Georgian or Victorian facade (40-60 sqm):
- Cement repointing: Â£3,000-Â£5,000
- Lime repointing: Â£6,000-Â£12,000
...
Modern masonry paints are typically impermeableâ€”avoid on traditionally built walls.
...
Lime mortar is not heritage nostalgiaâ€”it is the technically correct material for traditional buildings. The widespread switch to cement in the twentieth century has caused more damage to Britain's historic building stock than bombing, weather, and neglect combined.
